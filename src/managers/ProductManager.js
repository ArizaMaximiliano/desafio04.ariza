...
class ProductManager {
    ...
    async addProduct(product) {
        try {
            ...
            // if (!title || !description || !code || !price || !status || !category) {        //Verifico todos los campos---- lo quite porque me causaba error al agregar los del socket
    ...
    async deleteProduct(id) {
        ...
        const productIndex = products.findIndex((product) => product.id === id);    //Busco id en la lista
